...
@section('content')
    ...
    <div class="mb-6 sm:mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 mb-4">
            ...
            <div>
                ...
                <p class="text-gray-600 text-sm sm:text-base mt-1">Isi formulir di bawah untuk menambah user</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-lg border border-gray-200 p-4 sm:p-6 lg:p-8 max-w-2xl">
        <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-4 sm:space-y-6">
            ...
            <div>
                <label for="password_confirmation" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2">Konfirmasi Password *</label>
                <input 
                    type="password" 
